...
% alpha   - the balancing parameter of the data-fidelity constraint数据保真度约束的平衡参数
...
% u_hat   - spectra of the modes各模态的谱
% omega   - estimated mode center-frequencies各模态的中心频率
%
